    ...
    return (
        <div>
            <form className='flex justify-center m-auto' >
                ...
                <button className='bg-blue-800 py-[10px] md:py-[5px] px-[20px] rounded-br-lg rounded-tr-lg text-white flex items-center font-bold text-2xl' aria-label="Search Button"><ion-icon name="search"></ion-icon></button>
            </form>
