            ...
            <footer className=''>
                <div className='flex flex-col md:flex-row justify-between mx-[20px]'>
                    ...
                    <div className='my-[10px] md:w-[calc(33.33%-10px)] md:flex md:flex-col md:justify-center md:m-auto '>
                        ...
                        <div className='my-[10px]'>
                            <div className='md:flex md:justify-between md:flex-wrap list-none space-y-2 text-[15px] md:mx-0 mx-[10px] font-normal'>
                                  <li className='md:w-[calc(50%-10px)] hover:text-gray-600'>
                                    <svg className="h-6 w-6 text-gray-600" aria-hidden="true" fillRule="currentColor" viewBox="0 0 24 24">
